...
class ExternalShortwaveRadiation:
    ...
    def calculate_ratio_of_clear_sky_diffuse_on_horizontal_to_tilted(self):
        ...
        Y[Y<0.45] = 0.45
        self.ratio_of_clear_sky_diffuse_on_horizontal_to_tilted = pd.Series(Y, index=self.time.datetime_range)
    ...
    def calculate_incident_direct_radiation(self):
        ...
        self.incident_direct_radiation = pd.Series(incident_direct_radiation, index=self.time.datetime_range)
    ...
    def calculate_incident_diffuse_radiation(self):
        ...
        self.incident_diffuse_radiation = pd.Series(incident_diffuse_radiation, index=self.time.datetime_range)
    ...
    def calculate_incident_reflected_radiation(self):
        ...
        self.incident_reflected_radiation = pd.Series(incident_reflected_radiation, index=self.time.datetime_range)
    ...
    def calculate_incident_total_radiation(self):
        ...
        self.incident_total_radiation = pd.Series(incident_total_radiation, index=self.time.datetime_range)
    ...
    def calculate_incident_total_heat_flux(self):
        ...
        self.incident_total_heat_flux = pd.Series(incident_total_heat_flux, index=self.time.datetime_range)
